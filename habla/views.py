...
def efaistuff(request):
    ...
    static_path = os.path.join(settings.STATIC_ROOT, 'data/weather_codes.json')
    ...
    time_zones_path = os.path.join(settings.STATIC_ROOT, 'data/time_zones.json')
    with open(time_zones_path) as f:
